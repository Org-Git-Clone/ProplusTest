    ...
    return Scaffold(
        ...
        body: Consumer<RepositoryProvider>(builder: (context, provider, child) {
          return SingleChildScrollView(
              child: Column(
                  children: [wCompanyCard(provider), wProjectList(provider)]));
        }));
  }
              ...
              children: [
                Container(
                  ...
                  decoration: ShapeDecoration(
                    ...
                    shape: RoundedRectangleBorder(
                      side:
                          const BorderSide(width: 1, color: Color(0xFFF5F5FD)),
                      borderRadius: BorderRadius.circular(10),
                    ),
                  ),
                  // child: Image.network(repoInfo.),git commit -m "first commit"
